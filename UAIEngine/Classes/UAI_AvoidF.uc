...
============================================================================= */
class UAI_AvoidF extends UAI_Avoid;
...
event Tick( float DeltaTime )
{
	...
	// Base Forces
	SteerForce += HitNormal * MaxSpeed * DeltaTime * Mult * amod;
//	SteerForce *= (1-HitAngle)*f0;
	SteerForce = VTrunc(MaxForce*MaxSpeed, SteerForce);

	MoveForce = vector(rotation)*BaseSpeed * vmod * (1-HitAngle);
